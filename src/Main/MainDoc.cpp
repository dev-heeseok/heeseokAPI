...
BEGIN_MESSAGE_MAP(CMainDoc, CDocBase)
	...
	ON_COMMAND_RANGE(ID_TEST_EXECUTE_BTN, ID_TEST_EXECUTE_BTN, OnRibbonCategory)
	/** Develop Category Command */
	...
	/** Home Category UpdateUI */
	ON_UPDATE_COMMAND_UI(ID_TEST_EXECUTE_BTN, OnRibbonCategoryUI)
	/** Develop Category  UpdateUI */
	ON_UPDATE_COMMAND_UI(ID_MAIN_RBMENU_DEV_EXAMPLE_BTN, OnRibbonCategoryUI)
	ON_UPDATE_COMMAND_UI(ID_MAIN_RBMENU_DEV_EXAMPLE_CHK, OnRibbonCategoryUI)
	ON_UPDATE_COMMAND_UI(ID_MAIN_RBMENU_DEV_EXAMPLE_CMB, OnRibbonCategoryUI)
	ON_UPDATE_COMMAND_UI(ID_MAIN_RBMENU_DEV_EXAMPLE_EDIT_CMB, OnRibbonCategoryUI)
	ON_UPDATE_COMMAND_UI(ID_MAIN_RBMENU_DEV_EXAMPLE_MENU, OnRibbonCategoryUI)
	ON_UPDATE_COMMAND_UI(ID_MAIN_RBMENU_DEV_EXAMPLE_MENU_ITEM1, OnRibbonCategoryUI)
	ON_UPDATE_COMMAND_UI(ID_MAIN_RBMENU_DEV_EXAMPLE_MENU_ITEM2, OnRibbonCategoryUI)
	ON_UPDATE_COMMAND_UI(ID_MAIN_RBMENU_DEV_UNIT_TEST_BTN, OnRibbonCategoryUI)
END_MESSAGE_MAP()
